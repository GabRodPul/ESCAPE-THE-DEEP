...
public class AudioManager : MonoSingle<AudioManager>
{
    ...
    {
        GRPU_Prefs.SetFloat(PREFS_MUS_VOL, musicVolume);
        GRPU_Prefs.SetBool32(PREFS_MUS_MUTE, musicMute);
        GRPU_Prefs.SetFloat(PREFS_SFX_VOL, sfxVolume);
        GRPU_Prefs.SetBool32(PREFS_SFX_MUTE, sfxMute);
    }

    public void LoadPrefs()
    {
        musicVolume = GRPU_Prefs.GetFloat(PREFS_MUS_VOL, musicVolume);
        musicMute = GRPU_Prefs.GetBool32(PREFS_MUS_MUTE, musicMute);
        sfxVolume = GRPU_Prefs.GetFloat(PREFS_SFX_VOL, sfxVolume);
        sfxMute = GRPU_Prefs.GetBool32(PREFS_SFX_MUTE, sfxMute);
    }
